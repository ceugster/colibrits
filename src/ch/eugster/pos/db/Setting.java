...
public class Setting extends Table
{
	...
	private int update;
	private String path;
	private boolean showAddCustomerMessage;
	private boolean searchCd;
	private String cdPath;
	private int receiptNumberLength = 6;
	...
	public static Setting getInstance()
	{
		if (Setting.setting == null)
		{
			...
			Setting.setting.comServer = Setting.setting.new ComServer(Setting.setting);
	...
	private static Setting selectById(Long id)
	{
		IdentityFactory identityFactory = new IdentityFactoryImpl(Database.getCurrent().getBroker());
		Identity identity = identityFactory.buildIdentity(Setting.class, id);
		Object object = Database.getCurrent().getBroker().getObjectByIdentity(identity);
