 ...
 * </p>
 */
public class UserVerificationDialog extends Dialog
{
	 ...
	 */
	private UserVerificationInputValidator validator;
	 ...
	 */
	public UserVerificationDialog(Shell parentShell, String dialogTitle, String dialogMessage, String initialValue,
					UserVerificationInputValidator validator)
	{
		super(parentShell);
	...
	protected void buttonPressed(int buttonId)
	{
		if (buttonId == IDialogConstants.OK_ID)
		{
			...
			if (user.username.toLowerCase().equals(this.userName.toLowerCase()) && this.password.equals(user.password))
			{
				if (this.validator != null)
				{
					...
					{
						this.getErrorMessageLabel().setText("Dieser Benutzer hat keine Zugriffsberechtigung."); //$NON-NLS-1$
						this.passwordField.setText(""); //$NON-NLS-1$
						this.userNameField.setFocus();
						this.password = null;
						return;
	...
	protected Control createDialogArea(Composite parent)
	{
		...
		// userNameField.addModifyListener(
		// new ModifyListener() {
		...
		// passwordField.addModifyListener(
		// new ModifyListener() {
		// public void modifyText(ModifyEvent e) {
		// validateInput(e);
		// }
	 ...
	 */
	protected IUserVerificationInputValidator getValidator()
	{
