...
public class DBResult
{
	...
	public static final String SQLSTATE_NO_CONNECTION_ERROR = Messages.getString("DBResult.08S01_18"); //$NON-NLS-1$
	
	public static final String STORE_FAILED_TEXT = Messages
					.getString("DBResult.Der_Datensatz_konnte_nicht_gespeichert_werden._19"); //$NON-NLS-1$
	public static final String REMOVAL_FAILED_TEXT = Messages
					.getString("DBResult.Der_Datensatz_konnte_nicht_gel_u00F6scht_werden._20"); //$NON-NLS-1$
	public static final String SQL_ERROR_TEXT = ""; //$NON-NLS-1$
	public static final String NO_CONNECTION_ERROR_TEXT = Messages
					.getString("DBResult.Zur_aktuellen_Datenbank_besteht_keine_Verbindung_oder_die_Verbindung_ist_unterbrochen._22"); //$NON-NLS-1$
}
