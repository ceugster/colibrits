 ...
 *         Window>Preferences>Java>Code Generation>Code and Comments
 */
public class ReverseAction extends ModeDependendAction
{
	 ...
	 * @param key
	 */
	public ReverseAction(UserPanel context, Key key)
	{
		super(context, key);
		this.init(key);
	}
	 ...
	 * @param name
	 */
	public ReverseAction(UserPanel context, Key key, String name)
	{
	 ...
	 * @param icon
	 */
	public ReverseAction(UserPanel context, Key key, String name, Icon icon)
	{
