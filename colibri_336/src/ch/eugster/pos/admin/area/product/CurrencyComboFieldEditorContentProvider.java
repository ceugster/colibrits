...
public class CurrencyComboFieldEditorContentProvider
	...
	public Object doLoad() {
		return editor.getStore().getForeignCurrency(ProductGroupFieldEditorPage.KEY_CURRENCY);
	}
	...
	public Object doLoadDefault() {
		return editor.getStore().getDefaultForeignCurrency(ProductGroupFieldEditorPage.KEY_CURRENCY);
	}
