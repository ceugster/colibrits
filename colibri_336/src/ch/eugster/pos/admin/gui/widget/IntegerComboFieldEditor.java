 ...
 */
public class IntegerComboFieldEditor extends FieldEditor
{
	...
	private Integer newValue = new Integer(0);
	 ...
	 * @param values
	 */
	public IntegerComboFieldEditor(String name, String labelText, Composite parent, String[] list, Integer[] values)
	{
	...
	{
		return this.values[this.getCombo().getSelectionIndex()];
	}
	
	public void setItems(String[] items, Integer[] values)
	{
		this.values = values;
		Integer value = new Integer(0);
		if (this.combo.getSelectionIndex() == -1)
		{
			value = this.getStore().getInt(this.getName());
		}
		else
		{
	...
	protected void doFillIntoGrid(Composite parent, int numColumns)
	{
		...
		this.combo.addSelectionListener(new SelectionAdapter()
		{
			...
			{
				IntegerComboFieldEditor.this.selectionChanged(e);
			}
		});
	}
	...
	public Combo getComboControl(Composite parent)
	{
		if (this.combo == null)
		{
			...
			this.combo.addDisposeListener(new DisposeListener()
			{
				...
				{
					IntegerComboFieldEditor.this.combo = null;
				}
			});
		}
		else
	...
	private void selectionChanged(SelectionEvent e)
	{
		if (e.getSource().equals(this.combo))
		{
			...
			Integer oldValue = this.newValue;
	...
	{
		if (this.getContentValidator() != null)
		{
			this.isValid = this.getContentValidator().isValid(this);
		}
	}
	...
	{
		Integer value = this.getStore().getInt(this.getName());
	...
	{
		Integer value = this.getStore().getDefaultInt(this.getName());
		for (int i = 0; i < this.values.length; i++)
		{
			if (this.values[i].equals(value))
			{
